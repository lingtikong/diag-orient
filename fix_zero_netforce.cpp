...
FixZeroNetForce::FixZeroNetForce(LAMMPS *lmp, int narg, char **arg) :
  Fix(lmp, narg, arg)
{
...
void FixZeroNetForce::setup(int vflag)
{
...
void FixZeroNetForce::min_setup(int vflag)
{
  post_force(vflag);
}
...
void FixZeroNetForce::post_force(int vflag)
{
...
void FixZeroNetForce::post_force_respa(int vflag, int ilevel, int iloop)
{
...
void FixZeroNetForce::min_post_force(int vflag)
{
  post_force(vflag);
}
...
double FixZeroNetForce::compute_vector(int n)
{
